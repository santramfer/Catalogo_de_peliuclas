package com.azhar.peliculas.fragment;
...
import com.azhar.peliculas.activities.DetailMovieActivity;
import com.azhar.peliculas.adapter.MovieAdapter;
import com.azhar.peliculas.adapter.MovieHorizontalAdapter;
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(getActivity(), "¡Error al mostrar los datos!", Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onError(ANError anError) {
                        progressDialog.dismiss();
                        Toast.makeText(getActivity(), "¡Sin red de Internet!", Toast.LENGTH_SHORT).show();
                    }
                });
    }
