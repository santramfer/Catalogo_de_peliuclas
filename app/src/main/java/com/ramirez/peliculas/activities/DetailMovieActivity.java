package com.azhar.peliculas.activities;
...
import com.azhar.peliculas.R;
import com.azhar.peliculas.adapter.TrailerAdapter;
import com.azhar.peliculas.model.ModelMovie;
import com.azhar.peliculas.model.ModelTrailer;
import com.azhar.peliculas.networking.ApiEndpoint;
import com.azhar.peliculas.realm.RealmHelper;
...
public class DetailMovieActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.setMessage("Mostrando el tráiler");
                ...
                new MaterialFavoriteButton.OnFavoriteChangeListener() {
                    ...
                    public void onFavoriteChanged(MaterialFavoriteButton buttonView, boolean favorite) {
                        if (favorite) {
                            ...
                            Snackbar.make(buttonView, modelMovie.getTitle() + " Agregar a favoritos",
                                    Snackbar.LENGTH_SHORT).show();
                        } else {
                            helper.deleteFavoriteMovie(modelMovie.getId());
                            Snackbar.make(buttonView, modelMovie.getTitle() + " Eliminar de favoritos",
                                    Snackbar.LENGTH_SHORT).show();
                        }
        ...
        AndroidNetworking.get(ApiEndpoint.BASEURL + ApiEndpoint.MOVIE_VIDEO + ApiEndpoint.APIKEY + ApiEndpoint.LANGUAGE)
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            Toast.makeText(DetailMovieActivity.this,
                                    "Error al mostrar datos!", Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onError(ANError anError) {
                        progressDialog.dismiss();
                        Toast.makeText(DetailMovieActivity.this,
                                "sin red de internet!", Toast.LENGTH_SHORT).show();
                    }
                });
    }
