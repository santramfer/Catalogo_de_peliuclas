...
public class com_azhar_peliculas_model_ModelMovieRealmProxy extends com.azhar.peliculas.model.ModelMovie
    implements RealmObjectProxy, com_azhar_peliculas_model_ModelMovieRealmProxyInterface {
    ...
    private ProxyState<com.azhar.peliculas.model.ModelMovie> proxyState;

    com_azhar_peliculas_model_ModelMovieRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.azhar.peliculas.model.ModelMovie>(this);
    ...
    @SuppressWarnings("cast")
    public static com.azhar.peliculas.model.ModelMovie createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.azhar.peliculas.model.ModelMovie obj = realm.createObjectInternal(com.azhar.peliculas.model.ModelMovie.class, true, excludeFields);

        final com_azhar_peliculas_model_ModelMovieRealmProxyInterface objProxy = (com_azhar_peliculas_model_ModelMovieRealmProxyInterface) obj;
        if (json.has("Id")) {
            if (json.isNull("Id")) {
    ...
    public static com.azhar.peliculas.model.ModelMovie createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.azhar.peliculas.model.ModelMovie obj = new com.azhar.peliculas.model.ModelMovie();
        final com_azhar_peliculas_model_ModelMovieRealmProxyInterface objProxy = (com_azhar_peliculas_model_ModelMovieRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.azhar.peliculas.model.ModelMovie copyOrUpdate(Realm realm, com.azhar.peliculas.model.ModelMovie object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.azhar.peliculas.model.ModelMovie) cachedRealmObject;
        }

        return copy(realm, object, update, cache);
    }

    public static com.azhar.peliculas.model.ModelMovie copy(Realm realm, com.azhar.peliculas.model.ModelMovie newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.azhar.peliculas.model.ModelMovie realmObject = realm.createObjectInternal(com.azhar.peliculas.model.ModelMovie.class, false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_azhar_peliculas_model_ModelMovieRealmProxyInterface realmObjectSource = (com_azhar_peliculas_model_ModelMovieRealmProxyInterface) newObject;
        com_azhar_peliculas_model_ModelMovieRealmProxyInterface realmObjectCopy = (com_azhar_peliculas_model_ModelMovieRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.azhar.peliculas.model.ModelMovie object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.azhar.peliculas.model.ModelMovie.class);
        long tableNativePtr = table.getNativePtr();
        ModelMovieColumnInfo columnInfo = (ModelMovieColumnInfo) realm.getSchema().getColumnInfo(com.azhar.peliculas.model.ModelMovie.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        Table.nativeSetLong(tableNativePtr, columnInfo.IdIndex, rowIndex, ((com_azhar_peliculas_model_ModelMovieRealmProxyInterface) object).realmGet$Id(), false);
        String realmGet$Title = ((com_azhar_peliculas_model_ModelMovieRealmProxyInterface) object).realmGet$Title();
        if (realmGet$Title != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.TitleIndex, rowIndex, realmGet$Title, false);
        }
        Table.nativeSetDouble(tableNativePtr, columnInfo.VoteAverageIndex, rowIndex, ((com_azhar_peliculas_model_ModelMovieRealmProxyInterface) object).realmGet$VoteAverage(), false);
        String realmGet$Overview = ((com_azhar_peliculas_model_ModelMovieRealmProxyInterface) object).realmGet$Overview();
        if (realmGet$Overview != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.OverviewIndex, rowIndex, realmGet$Overview, false);
        }
        String realmGet$ReleaseDate = ((com_azhar_peliculas_model_ModelMovieRealmProxyInterface) object).realmGet$ReleaseDate();
        ...
        String realmGet$PosterPath = ((com_azhar_peliculas_model_ModelMovieRealmProxyInterface) object).realmGet$PosterPath();
        ...
        String realmGet$BackdropPath = ((com_azhar_peliculas_model_ModelMovieRealmProxyInterface) object).realmGet$BackdropPath();
        ...
        String realmGet$Popularity = ((com_azhar_peliculas_model_ModelMovieRealmProxyInterface) object).realmGet$Popularity();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        ModelMovieColumnInfo columnInfo = (ModelMovieColumnInfo) realm.getSchema().getColumnInfo(com.azhar.peliculas.model.ModelMovie.class);
        com.azhar.peliculas.model.ModelMovie object = null;
        while (objects.hasNext()) {
            object = (com.azhar.peliculas.model.ModelMovie) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.azhar.peliculas.model.ModelMovie object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.azhar.peliculas.model.ModelMovie.class);
    ...
    public static com.azhar.peliculas.model.ModelMovie createDetachedCopy(com.azhar.peliculas.model.ModelMovie realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.azhar.peliculas.model.ModelMovie unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.azhar.peliculas.model.ModelMovie();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.azhar.peliculas.model.ModelMovie) cachedObject.object;
            }
            unmanagedObject = (com.azhar.peliculas.model.ModelMovie) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_azhar_peliculas_model_ModelMovieRealmProxyInterface unmanagedCopy = (com_azhar_peliculas_model_ModelMovieRealmProxyInterface) unmanagedObject;
        com_azhar_peliculas_model_ModelMovieRealmProxyInterface realmSource = (com_azhar_peliculas_model_ModelMovieRealmProxyInterface) realmObject;
    ...
    public boolean equals(Object o) {
        ...
        com_azhar_peliculas_model_ModelMovieRealmProxy aModelMovie = (com_azhar_peliculas_model_ModelMovieRealmProxy)o;
